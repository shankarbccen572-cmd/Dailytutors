...
export const SITE_DEFAULTS = {
  ...
  heroBanners: [
    { title: '8 AM IST • Every Morning', subtitle: 'Start your day with curated current affairs from The Hindu, PIB, and Indian Express.', imageUrl: '', bgColor: '#8B0000', textColor: '#FFFFFF', ctaText: "Read Today's Brief", ctaHref: '/courses', position: 1 },
    { title: 'Live Classes Every Day', subtitle: 'Stay on top of your syllabus with live sessions and doubt solving every day.', imageUrl: '', bgColor: '#B22222', textColor: '#FFFFFF', ctaText: 'Join Live Now', ctaHref: '/learn', position: 2 },
    { title: 'Practice with Mock Tests', subtitle: 'Build confidence with daily mock tests, quizzes, and performance tracking.', imageUrl: '', bgColor: '#C00000', textColor: '#FFFFFF', ctaText: 'Start Practice', ctaHref: '/courses', position: 3 },
    { title: 'Expert Mentorship', subtitle: 'Learn from experienced tutors who guide your prep with strategy and clarity.', imageUrl: '', bgColor: '#DC143C', textColor: '#FFFFFF', ctaText: 'Meet Mentors', ctaHref: '/login', position: 4 },
    { title: 'Track Progress Effortlessly', subtitle: 'Get daily analytics, scorecards, and study plans tailored for your goals.', imageUrl: '', bgColor: '#B22234', textColor: '#FFFFFF', ctaText: 'View Dashboard', ctaHref: '/dashboard', position: 5 },
  ],
  ...
  examCategories: [
    ...
    { icon: 'Landmark', title: 'UPSC / KAS', tags: ['Prelims', 'Mains'], href: '/courses' },
    { icon: 'Calculator', title: 'CA & Commerce', tags: ['Foundation', 'Inter', 'Final'], href: '/courses' },
  ],
  ...
  footerAbout: "India's smart learning platform — live classes, daily practice and mentorship for boards, NEET, JEE, CET, UPSC and more.",
  footerColumns: [
    { title: 'Explore', links: [{ label: 'Courses', href: '/courses' }, { label: 'Learn', href: '/learn' }, { label: 'Dashboard', href: '/dashboard' }] },
    { title: 'Exams', links: [{ label: 'NEET', href: '/courses' }, { label: 'JEE / CET', href: '/courses' }, { label: 'Boards 8–12', href: '/courses' }, { label: 'UPSC / KAS', href: '/courses' }] },
  ...
  socialLinks: [
    ...
    { type: 'mail', href: 'mailto:hello@dailytutors.in' },
  ],
